...
local function get_groups()
  ...
  local groups = {
    ...
    StatusLine = { fg = colors.bg2, bg = colors.bg2, reverse = config.inverse },
    StatusLineNC = { fg = colors.fg4, bg = colors.fg4, reverse = config.inverse },
    ...
    PmenuSel = { fg = colors.bg3, bg = colors.fg1, bold = config.bold },
    ...
    TelescopePromptTitle = { fg = colors.bg0, bg = colors.fg4 },
    TelescopePreviewTitle = { fg = colors.bg0, bg = colors.fg4 },
    TelescopeResultsTitle = { fg = colors.bg0, bg = colors.fg4 },
