...
local function get_colors()
  ...
  local color_groups = {
    dark = {
      bg0_hard = p.dark0_hard,
      bg0 = p.dark0,
      bg0_soft = p.dark0_soft,
      bg1 = p.dark1,
      bg2 = p.dark2,
      bg3 = p.dark3,
      bg4 = p.dark4,
      fg0_hard = p.light0_hard,
      fg0 = p.light0,
      fg0_soft = p.light0_soft,
      fg1 = p.light1,
      fg2 = p.light2,
      fg3 = p.light3,
      fg4 = p.light4,
    ...
    light = {
      bg0_hard = p.light0_hard,
      bg0 = p.light0,
      bg0_soft = p.light0_soft,
      bg1 = p.light1,
      bg2 = p.light2,
      bg3 = p.light3,
      bg4 = p.light4,
      fg0_hard = p.dark0_hard,
      fg0 = p.dark0,
      fg0_soft = p.dark0_soft,
      fg1 = p.dark1,
      fg2 = p.dark2,
      fg3 = p.dark3,
      fg4 = p.dark4,
...
local function get_groups()
  ...
  local groups = {
    ...
    GruvboxFloatWindow = { fg = colors.fg0, bg = colors.bg0_soft },
    GruvboxFloatWindowBorder = { fg = colors.bg0_soft, bg = colors.bg0_soft },
    Normal = config.transparent_mode and { fg = colors.fg1, bg = nil } or { fg = colors.fg1, bg = colors.bg0 },
    NormalFloat = { fg = colors.fg0, bg = colors.bg0_soft },
    FloatBorder = { link = "GruvboxFloatWindowBorder" },
    ...
    WinSeparator = config.transparent_mode and { fg = colors.bg1, bg = nil } or { fg = colors.bg1, bg = nil },
    WildMenu = { fg = colors.blue, bg = colors.bg2, bold = config.bold },
    Directory = { link = "GruvboxBlueBold" },
    Title = { fg = colors.fg2, bg = colors.bg0_soft },
    ...
    Statement = { fg = colors.red, bg = colors.bg0_soft },
    ...
    Pmenu = { link = "GruvboxFloatWindow" },
    PmenuSel = { fg = colors.bg0, bg = colors.fg2, bold = config.bold },
    PmenuSbar = { bg = colors.bg0_soft },
    PmenuThumb = { fg = colors.fg2, bg = colors.fg2 },
    ...
    TelescopeSelection = { fg = colors.yellow, bg = colors.bg1 },
    TelescopeSelectionCaret = { fg = colors.bg1, bg = colors.bg1 },
    TelescopeMultiSelection = { link = "GruvboxGray" },
    TelescopePromptBorder = { fg = colors.bg1, bg = colors.bg1 },
    TelescopeResultsBorder = { link = "GruvboxFloatWindowBorder" },
    TelescopePreviewBorder = { link = "GruvboxFloatWindowBorder" },
    TelescopeResultsNormal = { link = "GruvboxFloatWindow" },
    TelescopePreviewNormal = { link = "GruvboxFloatWindow" },
    TelescopeMatching = { link = "GruvboxBlue" },
    TelescopePromptPrefix = { fg = colors.blue, bg = colors.bg1 },
    TelescopePromptNormal = { fg = colors.fg0, bg = colors.bg1 },
    TelescopePromptTitle = { fg = colors.bg0, bg = colors.fg2 },
    TelescopePreviewTitle = { fg = colors.bg0, bg = colors.fg2 },
    TelescopeResultsTitle = { fg = colors.bg0, bg = colors.fg2 },
    CmpDoc = { fg = colors.fg0, bg = colors.bg0_hard },
    ...
    SagaBorder = { link = 'GruvboxFloatWindowBorder' },
    SagaNormal = { link = 'GruvboxFloatWindow' },
    SagaToggle = { link = 'Comment' },
    SagaBeacon = { bg = colors.red },
    SagaVirtLine = { fg = colors.bg1 },
    SagaSpinnerTitle = { link = 'GruvboxFloatWindow' },
    SagaSpinner = { link = 'GruvboxFloatWindow' },
    ...
    SagaCount = { bg = colors.gray, fg = colors.fg0, bold = true },
    SagaSep = { link = 'Comment' },
    ActionPreviewNormal  = { fg = colors.fg0, bg = colors.bg0_hard },
    ActionPreviewBorder = { fg = colors.bg0_hard, bg = colors.bg0_hard },
